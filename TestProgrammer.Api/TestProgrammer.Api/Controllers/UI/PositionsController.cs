...
namespace TestProgrammer.Api.Controllers.UI
{
    public class PositionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PositionID,PositionName")] Positions positions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PositionID,PositionName")] Positions positions)
        {
